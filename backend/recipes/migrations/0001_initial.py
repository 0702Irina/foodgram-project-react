# Generated by Django 3.2 on 2023-09-29 15:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('measurement_unit', models.CharField(choices=[('kilogram', 'kg'), ('pieces', 'PCS'), ('cup', 'cup'), ('tablespoon', 'Tsp'), ('teaspoon', 'tsp')], help_text='Выберите единицу измерения', max_length=200, verbose_name='Единица измерения')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', colorfield.fields.ColorField(default='#FF0000', help_text='Выберите цвет, нажмите на цветной квадрат', image_field=None, max_length=25, samples=None, verbose_name='Цвет')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.PositiveIntegerField(help_text='Введите количество ингедиента', verbose_name='Количество')),
                ...
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipengredients', to='recipes.recipe', verbose_name='Рецепт')),
            ],
            options={
